                ...
                <table class="mt-4 w-full text-sm">
                    ...
                    <tbody>
                        <tr class="h-24">
                            ...
                            <td class="px-4 py-2 border-t border-b text-center">
                                <a href="{{ route('admin.laporanMahasiswa') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md">Proses</a>
                            </td>
                        </tr>
                        <tr class="h-24">
                            <td class="px-4 py-2 border-t border-b text-center">1</td>
                            ...
                            <td class="px-4 py-2 border-t border-b text-center">
                                <button class="bg-blue-500 text-white px-4 py-2 rounded-md">Lihat</button>
                            </td>
                        </tr>
                    </tbody>
                </table>

...
<div class="p-4 sm:p-6">
    <div class="flex justify-between items-center mt-2">
        ...
        <a href="{{ route('admin.tambahMahasiswa') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md">Tambah Mahasiswa</a>
    </div>
            ...
            <table class="mt-4 w-full text-sm">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="px-4 py-2 text-center">NIK Mahasiswa</th>

...
@section('contentUser')
    <div class="p-6">
        ...
        <div class="bg-white shadow-lg p-6 rounded-lg">
            <div class="mb-6">
                <textarea disabled id="balas_keluhan" placeholder="Masih belum ada balasan...." name="balas_keluhan" class="mt-1 block w-full h-[150px] text-gray-700 border border-gray-300 rounded-md p-2 bg-[#F5F6FA] resize-none" style="vertical-align: top;"></textarea>
            </div>
